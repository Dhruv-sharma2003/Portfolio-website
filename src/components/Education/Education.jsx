...
const educationData = [
  {
    ...
    year: '2022 - Present',
    description: 'I am pursuing my B.Tech in Computer Science and Engineering. During my time here, I have gained hands-on experience in software development, data structures, algorithms and project-based learning. ',
    
  },
  {
    institution: 'Army Public School at Patiala, Punjab',
